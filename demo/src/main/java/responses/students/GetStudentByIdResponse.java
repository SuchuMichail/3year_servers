...
public class GetStudentByIdResponse {
    ...
    public GetStudentByIdResponse(Student student) {
        this(student.getId(), student.getLastName(), student.getFirstName(), student.getMiddleName(), student.getStatus(), new GetStudentGroupByIdResponse(student.getStudentGroup()));
    }
}
